...
/AirBnB_clone$ ./console.py 3. When this command is run the following prompt should appear:
...
Testing 📏
Unittests for the ALX hbnb project are defined in the tests folder. To run the entire test suite simultaneously, execute the following command:
